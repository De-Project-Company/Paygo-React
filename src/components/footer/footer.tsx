  ...
  return (
    <footer className={clsx(commonStyles.fullBleed, footerStyles.footer)}>
      <div>
        <Logo secondary />
        <p>
          PayGo is an application that enables small businesses to manage their
          payments efficiently, by allowing business owners to create profiles
          for each of their clients, track payment transactions, and receive
      ...
      <div className={footerStyles.footerSubContainer}>
        ...
        <div className={footerStyles.copyright}>
          <p>
            &copy; {new Date().getFullYear()} Invoice Suite. | All Rights
            Reserved.{' '}
          </p>
