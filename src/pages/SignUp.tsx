...
const SignUp = () => {
  ...
  return (
    <AuthLayout
      linkData={{ route: routes.signIn(), label: 'Login to existing account' }}
    >
      <div className="lg:grid lg:grid-cols-2 gap-6 justify-center [&>div]:max-w-[600px] pb-16  primary-padding">
        <div className="hidden lg:block w-full">
          <img
            src="/assets/sign-up-mockup-img.png"
            alt="sign up mockup"
            className="w-full"
          />
        </div>

        <div className="bg-white p-10 w-full mx-auto border border-[#DEE2E6] rounded-xl">
          <Logo />

          <h2 className="mb-2 mt-9 text-[24px] text-gray-700">
          ...
          >
            ...
            <button
              disabled={isPending}
              className="bg-blue-600 text-white w-full rounded-md p-4 text-center mt-12 mb-3"
            >
          ...
          <p>
            ...
            <Link to={routes.signIn()} className="font-semibold text-blue-600">
              Login
            </Link>
          </p>
        </div>
